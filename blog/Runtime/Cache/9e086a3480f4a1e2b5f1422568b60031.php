	...
	<div class="blog-header">
		...
		<div class="blog-header-menu-container">
			<div class="blog-header-menu">
				<ul>
					<li class="fstmenu"><a href="" target="_self">网站首页</a></li>
					<li class="fstmenu"><a href="" target="_blank">互联网资讯</a></li>
					<li class="fstmenu"><a href="" target="_blank">前端技术</a>
					...
					<li class="fstmenu"><a href="">PHP技术</a>
					...
					<li class="fstmenu"><a href="" target="_blank">Linux</a>
					</li>
					<li class="fstmenu"><a href="" target="_blank">Github</a>
					</li>
					<li class="fstmenu"><a href="" target="_blank">随笔情怀</a>
					</li>
				</ul>
			</div>
		</div>
